          ...
          <div className="max-h-80 overflow-y-auto">
            ...
            <TabsContent value="overview" className="p-4 space-y-3 mt-0">
              <div>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  ...
                  <span className="text-foreground font-medium"> 전략 중심의 마크다운 문서</span>
                  입니다. 단순 데이터 요약이 아닌, 실제 의사결정에 활용 가능한 수준의 분석과 전략을
                  제공합니다.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground mt-1.5">
                  Stage 4(고급 분석) 완료 시 리포트가 자동으로 재생성되어 고급 분석 내용이
                  추가됩니다.
                </p>
              </div>
              ...
              <div>
                ...
                <ol className="space-y-1 text-xs text-muted-foreground">
                  <li className="flex gap-2">
                    ...
                    <span>
                      <span className="text-foreground">전체 여론 구조</span> — 거시적 여론 흐름과
                      트렌드
                    </span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span>
                      <span className="text-foreground">집단별 반응 분석</span> — 세그먼트별 특성과
                      크기
                    </span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span>
                      <span className="text-foreground">감정 및 프레임 분석</span> — 미디어
                      프레이밍과 감정 톤
                    </span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span>
                      <span className="text-foreground">메시지 효과 분석</span> — 발언/이벤트의 여론
                      영향
                    </span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span>
                      <span className="text-foreground">리스크 분석</span> — 잠재 위협과 대응 필요
                      사항
                    </span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span>
                      <span className="text-foreground">기회 분석</span> — 활용 가능한 긍정 요소
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <Badge
                    ...
                    <span>
                      <span className="text-foreground">전략 도출</span> — 메시지·매체·위기 대응
                      전략
                    </span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span>
                      <span className="text-foreground">최종 전략 요약</span> — 핵심 발견과 즉시
                      행동 사항
                    </span>
                  </li>
                </ol>
              ...
              <div className="rounded-lg bg-muted/50 p-2.5">
                <p className="text-[10px] text-muted-foreground">
                  ...
                  <span className="text-foreground">
                    지지율 추정, 프레임 전쟁, 위기 시나리오, 승리 시뮬레이션
                  </span>{' '}
                  섹션이 추가됩니다.
                </p>
              </div>
            ...
            <TabsContent value="sections" className="p-4 space-y-3 mt-0">
              <p className="text-xs text-muted-foreground">
                각 섹션의 내용과 해당 분석 모듈을 안내합니다. 좌측 목차로 원하는 섹션으로 바로
                이동할 수 있습니다.
              </p>
                ...
                <CollapsibleContent>
                  <div className="ml-6 pl-2 border-l py-2 space-y-2">
                    {[
                      {
                        title: 'AI 지지율 추정',
                        desc: '수집 데이터 기반 지지율 추이 추정. 면책 문구가 반드시 포함됩니다.',
                      },
                      {
                        title: '프레임 전쟁 분석',
                        desc: '진영별 프레이밍 전략 비교. 지배적/위협/반전 가능 프레임을 구분합니다.',
                      },
                      {
                        title: '위기 시나리오',
                        desc: '최악/최선/가능성 높은 3가지 시나리오를 표 형태로 정리합니다.',
                      },
                      {
                        title: '승리 시뮬레이션',
                        desc: '최적 경로, 핵심 변수, 실행 타임라인을 도출합니다.',
                      },
                    ].map((item) => (
                      <div key={item.title}>
              ...
              <div>
                ...
                <ol className="space-y-1.5 text-xs text-muted-foreground">
                  <li className="flex gap-2">
                    ...
                    <span>
                      <span className="text-foreground">한 줄 요약</span>을 먼저 읽고 전체 맥락 파악
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <Badge
                    ...
                    <span>
                      <span className="text-foreground">최종 전략 요약</span>(마지막 섹션)으로 이동
                      — 핵심 행동 사항 확인
                    </span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span>
                      관심 있는 <span className="text-foreground">개별 섹션</span>을 좌측 목차로
                      점프하여 상세 확인
                    </span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    <span>
                      <span className="text-foreground">리스크 + 기회 + 전략</span> 섹션을 함께
                      읽으면 실행 계획 수립 가능
                    </span>
                  </li>
                </ol>
              ...
              <div>
                ...
                <ul className="space-y-1.5 text-xs text-muted-foreground">
                  <li className="flex gap-1.5">
                    <span className="text-primary shrink-0">→</span>
                    <span>
                      <span className="text-foreground">팀 브리핑용:</span> 한 줄 요약 + 최종 전략
                      요약을 슬라이드로 활용. PDF 내보내기로 공유
                    </span>
                  </li>
                  <li className="flex gap-1.5">
                    <span className="text-primary shrink-0">→</span>
                    <span>
                      <span className="text-foreground">위기 대응:</span> 리스크 분석 → 위기
                      시나리오(고급) → 전략 도출 순서로 즉시 대응 계획 수립
                    </span>
                  </li>
                  <li className="flex gap-1.5">
                    <span className="text-primary shrink-0">→</span>
                    <span>
                      <span className="text-foreground">메시지 전략:</span> 감정/프레임 분석 +
                      메시지 효과 → 전략 도출의 메시지 방향을 참고하여 핵심 메시지 작성
                    </span>
                  </li>
                  <li className="flex gap-1.5">
                    <span className="text-primary shrink-0">→</span>
                    <span>
                      <span className="text-foreground">정기 모니터링:</span> 매주/격주 동일
                      키워드로 분석 실행하여 리포트 비교 → 여론 변화 추적
                    </span>
                  </li>
                  <li className="flex gap-1.5">
                    <span className="text-primary shrink-0">→</span>
                    <span>
                      <span className="text-foreground">대시보드 연계:</span> 리포트의 서술 내용과
                      대시보드 차트를 교차 확인하면 더 깊은 인사이트 도출
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1.5 text-xs text-muted-foreground">
                  <li className="flex gap-1.5">
                    <span className="text-primary shrink-0">→</span>
                    <span>
                      <span className="text-foreground">좌측 목차:</span> 데스크톱에서 좌측
                      사이드바로 원하는 섹션에 바로 점프 (모바일은 상단 수평 탭)
                    </span>
                  </li>
                  <li className="flex gap-1.5">
                    <span className="text-primary shrink-0">→</span>
                    <span>
                      <span className="text-foreground">PDF 내보내기:</span> 브라우저 인쇄 기능으로
                      PDF 저장. 팀 공유 및 보고용으로 활용
                    </span>
                  </li>
                  <li className="flex gap-1.5">
                    <span className="text-primary shrink-0">→</span>
                    <span>
                      <span className="text-foreground">스크롤 추적:</span> 스크롤 위치에 따라 좌측
                      목차의 현재 섹션이 자동으로 하이라이트됨
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <TabsContent value="caution" className="p-4 space-y-3 mt-0">
                ...
                <ul className="space-y-2 text-xs text-muted-foreground">
                  <li className="flex gap-1.5">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5">
                        리포트는 AI가 분석 데이터를 기반으로 생성한 것입니다. 최종 의사결정 전
                        전문가 검토를 권장합니다.
                      </p>
                    </div>
                  </li>
                  <li className="flex gap-1.5">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5">
                        수집된 플랫폼과 기간 내 데이터만 분석합니다. 비공개 커뮤니티, SNS DM,
                        오프라인 여론은 반영되지 않습니다.
                      </p>
                    </div>
                  </li>
                  <li className="flex gap-1.5">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5">
                        기사 1,000건(일별 균등), 영상 50건 등 기본 수집 한도가 있습니다. 전체 여론의
                        완벽한 대표성을 보장하지 않습니다.
                      </p>
                    </div>
                  </li>
                  <li className="flex gap-1.5">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5">
                        고급 분석의 지지율 추정은 온라인 여론 데이터 기반이며, 실제 여론조사와는
                        방법론이 다릅니다. 참고 자료로만 활용하세요.
                      </p>
                    </div>
                  </li>
                  <li className="flex gap-1.5">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5">
                        일부 분석 모듈이 실패한 경우, 리포트 상단에 누락된 모듈이 명시됩니다. 해당
                        섹션의 분석이 제한적일 수 있습니다.
                      </p>
                    </div>
                  </li>
              ...
              <div>
                ...
                <div className="space-y-2 text-xs text-muted-foreground">
                  ...
                  <div className="rounded-lg border p-2.5">
                    ...
                    <p>
                      기본 8개 섹션 + 고급 분석 4개 섹션(지지율, 프레임 전쟁, 위기 시나리오, 승리
                      시뮬레이션)이 추가됩니다. 자동으로 재생성됩니다.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-lg bg-muted/50 p-2.5">
                <p className="text-[10px] text-muted-foreground">
                  분석 모듈이 실패하더라도 가용한 결과로 리포트를 생성합니다. 누락된 부분은 리포트
                  내에서 명시됩니다.
                </p>
              </div>
            </TabsContent>
