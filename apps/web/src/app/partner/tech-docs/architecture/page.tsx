    ...
    <div className="space-y-5 max-w-6xl">
      ...
      <div>
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          ...
          <a
            href="/docs/tech-architecture-v3.html"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 rounded-md border px-3 py-1.5 text-sm font-medium hover:bg-muted/50 transition-colors shrink-0"
          >
      ...
      <div className="rounded-lg border bg-card overflow-hidden">
        ...
        <iframe
          src="/docs/tech-architecture-v3.html"
          className="w-full border-0"
          style={{ height: fullscreen ? 'calc(100vh - 180px)' : '75vh', minHeight: '500px' }}
          title="AI SignalCraft 완전 기술 아키텍처 v3"
        />
      </div>
    </div>
  );
