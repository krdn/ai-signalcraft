...
const opportunityResult = await runModuleWithContext(opportunity, input, {
  ...stage1Data,
  risk: riskResult,
});
const strategyResult = await runModuleWithContext(strategy, input, {
  ...stage1Data,
  risk: riskResult,
...
async function runModule<T>(module: AnalysisModule<T>, input: AnalysisInput) {
  ...
  const result = await analyzeStructured(module.buildPrompt(input), module.schema, {
        ...
        children: [
          {
            ...
            data: {
              ...
              keyword,
              stage: 1,
              modules: ['macro-view', 'segmentation', 'sentiment-framing', 'message-impact'],
            },
          },
        ],
      },
